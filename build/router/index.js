...
router.use('/categories', auth_middleware_1.isAuthenticated, category_router_1.categoryRouter);
router.use('/sub-categories', auth_middleware_1.isAuthenticated, subcategory_router_1.subCategoryRouter);
router.use('/transactions', auth_middleware_1.isAuthenticated, transaction_router_1.transactionRouter);
